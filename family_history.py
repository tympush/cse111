...
def print_death_age(people_dict):
    ...
    for key, person_list in people_dict.items():
        print(f"{person_list[NAME_INDEX]} {person_list[DEATH_YEAR_INDEX] - person_list[BIRTH_YEAR_INDEX]}")
...
def print_marriages(marriages_dict, people_dict):
    ...
    for key, marriage_list in marriages_dict.items():
        husband_name = people_dict[marriages_dict[key][HUSBAND_KEY_INDEX]][NAME_INDEX]
        wife_name = people_dict[marriages_dict[key][WIFE_KEY_INDEX]][NAME_INDEX]
        husband_age = marriages_dict[key][WEDDING_YEAR_INDEX] - people_dict[marriages_dict[key][HUSBAND_KEY_INDEX]][BIRTH_YEAR_INDEX]
        wife_age = marriages_dict[key][WEDDING_YEAR_INDEX] - people_dict[marriages_dict[key][WIFE_KEY_INDEX]][BIRTH_YEAR_INDEX]

        print(f"{husband_name} {husband_age} > {marriages_dict[key][WEDDING_YEAR_INDEX]} < {wife_name} {wife_age}")
