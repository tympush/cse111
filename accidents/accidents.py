...
def main():
    try:
        ...
        print(f"Error: line {reader.line_num} of accidents.csv is formatted incorrectly.")

    except ZeroDivisionError as zero_div_err:
        print(f"Error: line {reader.line_num} of accidents.csv contains 0 in the 'Fatal Crashes' or 'Cell Phone Use' column.")
